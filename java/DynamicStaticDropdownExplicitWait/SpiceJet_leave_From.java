...
public class SpiceJet_leave_From
{
	...
	public static void main(String[] args) throws ElementNotInteractableException,NoSuchWindowException
	{
...
//		List<WebElement>triptype = driver.findElements(By.xpath("//table[@id='ctl00_mainContent_rbtnl_Trip']//input"));
//		int tripcount = triptype.size();
//		System.out.println(tripcount);		
		
		Triptype = driver.findElement(By.xpath("//div[text()='one way']"));
		Triptype.click();
		
		//Explicit Wait
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(Triptype));

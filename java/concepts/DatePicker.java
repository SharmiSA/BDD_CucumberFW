...
public class DatePicker
{
	public static void main(String[] args) throws ElementClickInterceptedException, InterruptedException
    {
        ...
        String dateTime ="1/24/2025 8:30 PM";
       ...
       try
       {
        ...
        WebElement nextLink = driver.findElement(By.xpath("//div[@id='datetimepicker_dateview']//div[@class='k-header k-hstack']//span[contains(@class,'k-calendar-nav-next')]"));

        //button to click in center of calendar header

        WebElement midLink = driver.findElement(By.xpath("//div[@id='datetimepicker_dateview']//div[@class='k-header k-hstack']//span[contains(@class,'k-calendar-nav-fast')]"));

        //button to move previous month in calendar

        WebElement previousLink = driver.findElement(By.xpath("//div[@id='datetimepicker_dateview']//div[@class='k-header k-hstack']//span[contains(@class,'k-calendar-nav-prev')]")); 
